...
import 'package:ilmnur_app/features/login/data/data_sources/google_signin_service.dart';
...
class LoginScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) => LoginBloc(
        loginRepo: ImplLoginRepo(loginService: LoginService(Dio())),
      ),
            ...
            children: [
              BlocBuilder<LoginBloc, LoginState>(
                builder: (context, state) {
                  ...
                  } else if (state is LoadedLoginData) {
              ...
              SocalButton(
                press: () async {
                  ...
                  if (user != null) {
                    context.read<LoginBloc>().add(GoogleLogin(user));
                  } else {
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(content: Text("User data topilmadi!")),
                    );
                  }
                },

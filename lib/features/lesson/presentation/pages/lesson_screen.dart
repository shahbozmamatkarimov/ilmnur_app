...
import 'package:ilmnur_app/features/lesson/presentation/widgets/LectureView.dart';
    ...
    return Scaffold(
      ...
      body: BlocProvider(
        create: (context) => LessonBloc(
          id: widget.lessonId,
          lessonRepo: ImplLessonRepo(lessonService: LessonService.create()),
        ),

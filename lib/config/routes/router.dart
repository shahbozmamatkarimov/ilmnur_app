...
class AppRouter extends RootStackRouter {
  ...
  List<AutoRoute> get routes => [
    ...
    AutoRoute(
      ...
      initial: true,
      children: [
        AutoRoute(page: GroupsRoute.page, path: '', initial: true), // now safe
        ...
        AutoRoute(page: ReytingRoute.page, path: 'reyting/:id'),
...
//     AutoRoute(page: SignInRoute.page, path: '/login', initial: true),
//     AutoRoute(
//       path: '/',
//       page: HomeRoute.page,
//       // initial: true,
//       children: [
//         // AutoRoute(page: SignInRoute.page, path: 'login', initial: true),
//         AutoRoute(page: GroupsRoute.page, path: ''),
//         AutoRoute(page: MainRoute.page, path: 'group/:id'),
//         AutoRoute(page: CourseRoute.page, path: 'course/:courseId'),
//         AutoRoute(page: LessonRoute.page, path: 'lesson/:lessonId'),
